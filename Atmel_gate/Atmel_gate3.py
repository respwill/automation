...
turnkey = sch_check("Atmel(74,125,955)-TEST-CES V6.7.xlsm", "SCH(Turnkey)", "Lot# / Dcc", "T device", "Test PO",
                    tracecode_column="Trace", ship_column="SHIP", el_fg_column="EL FG", be_fg_column="BE(Tstck) FG", )
only = sch_check("Atmel(74,125,955)-TEST-CES V6.7.xlsm", "SCH(Only)", "Lot# / Dcc", "T device", "Test PO",
                 "Date", "Trace", "COO", "SHIP", el_fg_column="EL FG", be_fg_column="BE(Tstck) FG", )
